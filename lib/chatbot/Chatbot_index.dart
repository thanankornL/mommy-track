...
class Chatbot_index extends StatefulWidget {
  const Chatbot_index({super.key});

  @override
  State<Chatbot_index> createState() => _Chatbot_indexState();
}

class _Chatbot_indexState extends State<Chatbot_index> {
  ...
  callGeminiModel() async {
    try {
      ...
      final model = GenerativeModel(
        model: 'gemini-pro', // ✅ อย่าลืมแก้ชื่อโมเดลด้วย
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            Row(
              children: [
                Image.asset("assets/chatbot/gpt-robot.png"),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: Image.asset('assets/chatbot/send.png'),
                    ),
                  ),
                  SizedBox(width: 20),
                ],
